...
@Component({
  ...
  template: `
    ...
    <div class="flex flex-row items-center">
      <div
        class="material-icons text-white relative rounded-full h-14 w-14 flex items-center justify-center p-4 hover:bg-slate-300 hover:opacity-10 cursor-pointer"
      >
        logout
      </div>
      <div
        class="relative hiddem lg:flex items-center gap-4 p-4 rounded-full hover:bg-opacity-10 hover:bg-slate-300 cursor-pointer"
      >
    ...
    <div
      class="mt-6 lg:hidden h-12 w-12 rounded-full p-4 flex items-center justify-center bg-sky-500 hover:bg-opacity-80 transition cursor-pointer"
    >
